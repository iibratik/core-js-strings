 ...
 */
function getStringLength(income) {
 ...
 */
function isString(income) {
  if (typeof income === 'string' || income instanceof String) {
    return true;
  }
  return false;
}
 ...
 */
function concatenateStrings(income1, income2) {
  if (typeof income1 === 'string' && typeof income2 === 'string') {
    return income1.concat(income2);
  }
  return '';
}
 ...
 *   getFirstChar('') => ''
 */
function getFirstChar(income) {
  if (typeof income === 'string' && income.length > 0) {
 ...
 */
function removeLeadingAndTrailingWhitespaces(income) {
  return income.trim();
}
 ...
 */
function removeLeadingWhitespaces(income) {
  return income.trimStart();
}
 ...
 */
function removeTrailingWhitespaces(income) {
  return income.trimEnd();
}
 ...
 *   repeatString('abc', -2) => ''
 */
function repeatString(income, times) {
  if (typeof income === 'string' && typeof times === 'number' && times > 0) {
    return income.repeat(times);
  }
  return '';
}
 ...
 *   sumOfCodes() => 0
 */
function sumOfCodes(income) {
  if (typeof income !== 'string') {
    return 0;
  }
  let sum = 0;
  for (let index = 0; index < income.length; index += 1) {
    const code = income.charCodeAt(index);
    sum += code;
  }
  return sum;
}
